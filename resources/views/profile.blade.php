  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="shopper-profile">
        ...
        <div class="numbers-bought-transactions">
          <div class="bought">
            <p class="numbers">20</p>
            <p class="description">preloved items<br />bought</p>
          </div>
          <div class="transactions">
            <p class="numbers">20</p>
            <p class="description">transactions<br />completed</p>
          </div>
        </div>
        ...
        <div class="review">
          ...
          <p id="shopper-review">{{$profile -> role}} review</p>
        </div>
      </div>
